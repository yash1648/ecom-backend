package com.grim.notification.email;

import com.grim.notification.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        helper.setFrom("yashbagal623@gmail.com");
        ...
        try{
            ...
            log.warn("Cannot set email to {} ",destinationEmail);
        }
